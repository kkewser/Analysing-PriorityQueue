...
struct Node* NewLinkedNode(double x,struct Node*  node){
...
void Enqueue(double x,struct Node*  node){
    
    //printf("\n \n");
    //printf("New Enque operation: \n");
    //create a new node with the value of x
    struct Node* newNode = NewLinkedNode(x,node);
